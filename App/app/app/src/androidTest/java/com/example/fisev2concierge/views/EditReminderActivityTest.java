...
public class EditReminderActivityTest {
    ...
    @Test
    public void editReminderViewTest() {
        ...
        ViewInteraction appCompatEditText = onView(
                allOf(withId(R.id.reminderText),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        DataInteraction materialTextView = onData(anything())
                .inAdapterView(allOf(withId(R.id.remindersListView),
                        childAtPosition(
        ...
        ViewInteraction appCompatEditText2 = onView(
                allOf(withId(R.id.editReminderText), withText("test"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction appCompatEditText4 = onView(
                allOf(withId(R.id.editReminderText), withText("test"),
                        childAtPosition(
                                ...
                                2),
                        isDisplayed()));
        appCompatEditText4.perform(replaceText("test 2"));

        ViewInteraction appCompatEditText5 = onView(
                allOf(withId(R.id.editReminderText), withText("test 2"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
