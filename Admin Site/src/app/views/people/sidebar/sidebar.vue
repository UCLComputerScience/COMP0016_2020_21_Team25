<template>
    <aside class="sidebar centred noselect" ref="sidebar">
        <sidebar-header></sidebar-header>
        <div class="sidebar-content centred">
            <sidebar-content>
                           <span class="add-icon centred material-icons" v-on:click="addNewUser"
                                 v-show="showAddButton">add_circle</span>
            </sidebar-content>
        </div>
        <div class="sidebar-toggler centred" ref="toggler" v-on:click="toggleSidebar">
